...
const Manuel = () => {
  return (
    <div className="text-gray-600 body-font">
      <div className='text-center text-3xl bg-title-back h-28'>ご注文の流れ</div>
      <div className="container mx-auto max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <p className="text-start text-gray-700 md:text-lg">
         当店はセミセルフサービスとなっております。
         以下のご協力よろしくお願いいたします。
        </p>
      </div>
      <div className="grid gap-8 row-gap-0 lg:grid-cols-3 mb-10">
